...
session 是服务器给每个客户端分配的“身份标识”，客户端每次向服务器发请求的时候，都带上这个“身份标识”，服务器就知道这个请求来自于谁。**至于客户端怎么保存这个“身份标识”，可以有很多种方式，对于浏览器客户端，默认采用 cookie 的方式。**
...
**Cookie是存储在客户端一方，Session是存储在服务端一方，客户端只存储`SessionId`。**
